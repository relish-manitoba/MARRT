...
- **Description:** Low-contrast text is difficult or impossible for many users to read. [Learn how to provide sufficient color contrast](https://dequeuniversity.com/rules/axe/4.10/color-contrast).
- **Selector:** ul.navigation > li.nav-item > a#1999 > span.nav-label
- **Snippet:**
...
## 195. Serve images in next-gen formats
...
## 229. Avoid serving legacy JavaScript to modern browsers
...
## 280. Page prevented back/forward cache restoration
