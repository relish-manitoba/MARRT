...
- **Description:** Low-contrast text is difficult or impossible for many users to read. [Learn how to provide sufficient color contrast](https://dequeuniversity.com/rules/axe/4.10/color-contrast).
- **Selector:** ul.navigation > li.nav-item > a#2011 > span.nav-label
- **Snippet:**
...
## 56. `<frame>` or `<iframe>` elements do not have a title
...
## 57. Image elements do not have `[alt]` attributes
...
## 58. Image elements do not have `[alt]` attributes
...
## 59. Links do not have a discernible name
...
## 60. Links do not have a discernible name
...
## 61. Links rely on color to be distinguishable.
...
## 62. Touch targets do not have sufficient size or spacing.
...
## 63. Touch targets do not have sufficient size or spacing.
...
## 64. Touch targets do not have sufficient size or spacing.
...
## 65. Touch targets do not have sufficient size or spacing.
...
## 66. Touch targets do not have sufficient size or spacing.
...
## 67. Touch targets do not have sufficient size or spacing.
...
## 68. Touch targets do not have sufficient size or spacing.
...
## 77. Serve static assets with an efficient cache policy
...
## 78. Serve static assets with an efficient cache policy
...
## 79. Serve static assets with an efficient cache policy
...
## 80. Serve static assets with an efficient cache policy
...
## 81. Serve static assets with an efficient cache policy
...
## 82. Serve static assets with an efficient cache policy
...
## 83. Serve static assets with an efficient cache policy
...
## 123. Avoid enormous network payloads
...
## 124. Avoid enormous network payloads
...
## 125. Avoid enormous network payloads
...
## 126. Avoid enormous network payloads
...
## 127. Avoid enormous network payloads
...
## 128. Avoid enormous network payloads
...
## 129. Avoid enormous network payloads
...
## 133. Eliminate render-blocking resources
...
## 134. Eliminate render-blocking resources
...
## 135. Eliminate render-blocking resources
...
## 136. Eliminate render-blocking resources
...
## 137. Eliminate render-blocking resources
...
## 138. Eliminate render-blocking resources
...
## 139. Eliminate render-blocking resources
...
## 192. Serve images in next-gen formats
...
## 193. Serve images in next-gen formats
...
## 225. Avoid serving legacy JavaScript to modern browsers
...
## 226. Avoid serving legacy JavaScript to modern browsers
...
## 227. Avoid serving legacy JavaScript to modern browsers
...
## 277. Page prevented back/forward cache restoration
...
## 278. Page prevented back/forward cache restoration
...
## 327. Use efficient cache lifetimes
...
## 328. Use efficient cache lifetimes
...
## 329. Use efficient cache lifetimes
...
## 330. Use efficient cache lifetimes
...
## 331. Use efficient cache lifetimes
...
## 332. Use efficient cache lifetimes
...
## 333. Use efficient cache lifetimes
