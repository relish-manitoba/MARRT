...
## 10. Duplicate id attribute value "2022" found on the web page.
...
## 11. Duplicate id attribute value "2023" found on the web page.
...
```
<a class="nav-link" id="2023" aria-current="page" href="/site/educ/entrytopractice?nav=sidebar" target="_self">
...
```
<span class="nav-label">Degree for Entry to Practice</span>
```
...
## 15. This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 3:1, but text in this element has a contrast ratio of 2.67:1. Recommendation:  change text colour to #00a3b9.

- **Code:** WCAG2AA.Principle1.Guideline1_4.1_4_3.G145.Fail
- **Selector:** #content > h3:nth-child(4)
- **Type:** error
- **Type Code:** 1
- **Context:**
...
## 16. This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 3:1, but text in this element has a contrast ratio of 2.67:1. Recommendation:  change text colour to #00a3b9.

- **Code:** WCAG2AA.Principle1.Guideline1_4.1_4_3.G145.Fail
- **Selector:** #content > h3:nth-child(7)
- **Type:** error
- **Type Code:** 1
- **Context:**
