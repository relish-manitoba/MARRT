...
```
<a class="nav-link" id="2018" aria-current="page" href="/site/educ/becomeanRT?nav=sidebar" target="_self">
...
## 9. Duplicate id attribute value "2019" found on the web page.
...
```
<a href="https://umanitoba.ca/student/admissions/programs/respiratory-therapy.html" target="_blank" rel="noopener"><em class="fa fa-arrow-up-right...</a>
```
