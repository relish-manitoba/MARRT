...
```
<span class="nav-label">How to become an RT</span>
```
...
```
<a href="https://umanitoba.ca/student/admissions/programs/respiratory-therapy.html" target="_blank" rel="noopener"><em class="fa fa-arrow-up-right-from-square"></em></a>
```
