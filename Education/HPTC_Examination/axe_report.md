...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** .d-sm-none > .side-nav > .side-navbg > .menu-1995 > .currentMenuItem > .nav-link[aria-current="page"][href="/site/educ/forum?nav=sidebar"] > .nav-label
- **HTML:**

```
<span class="nav-label">HPTC Examination</span>
```
...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** .footerlink > a[href="/site/educ/cc?nav=sidebar"]
- **HTML:**
...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** .footerlink > a[href="/site/educ/forum?nav=sidebar"]
- **HTML:**
...
```
<a href="https://hptc.ysasecure.com/?locale=en">https://hptc.ysasecure.com/?locale=en</a>
```
...
- **Description:** Ensure links are distinguished from surrounding text in a way that does not rely on color
- **Selector:** p:nth-child(17) > a
- **HTML:**

```
<a href="https://drive.google.com/file/d/1_JrHRmfjLrsqqVgIQUkUz2zNTdVKsS9E/view?usp=sharing">YAS &amp; HPTC – Purchase &amp; Booking Process</a>
```
...
- **Description:** Ensure links are distinguished from surrounding text in a way that does not rely on color
- **Selector:** p:nth-child(19) > a:nth-child(1)
- **HTML:**

```
<a href="https://www.youtube.com/watch?v=6cg9tQuOOtQ">review this instructional video</a>
```
...
```
<a href="https://marrt.org/uploaded/web/HPTC-Candidate-Manual-July-2024-English.pdf" target="_blank" rel="noopener">Candidate Manual here</a>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** .d-sm-none > .side-nav > .side-navbg > .menu-1995
- **HTML:**

```
<ul class=" navigation menu-1995">
```
