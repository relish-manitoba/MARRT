...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** .col-md-3[align="center"]:nth-child(1) > .cta-btn-text > .cta-description
- **HTML:**

```
<span class="cta-description">Member access to Personal Profile, Meeting Minutes, Newsletter, Renewal Info</span>
```

- **Failure Summary:** Fix any of the following:
  Element has insufficient color contrast of 2.02 (foreground color: #ffffff, background color: #c2b59b, font size: 13.5pt (18px), font weight: bold). Expected contrast ratio of 4.5:1

## 3. Elements must meet minimum color contrast ratio thresholds

- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** .col-md-3[align="center"]:nth-child(2) > .cta-btn-text > .cta-description
- **HTML:**

```
<span class="cta-description">Interested in becoming a Registered Respiratory Therapist?</span>
```
...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** .col-md-3[align="center"]:nth-child(3) > .cta-btn-text > .cta-description
- **HTML:**

```
<span class="cta-description">Read information for the general public</span>
```
...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** .col-md-3[align="center"]:nth-child(4) > .cta-btn-text > .cta-description
- **HTML:**

```
<span class="cta-description">Look for a Registered Respiratory Therapist today.</span>
```
...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** div:nth-child(2) > .short-description > .readmore
- **HTML:**
...
- **Failure Summary:** Fix any of the following:
  Element has insufficient color contrast of 2.67 (foreground color: #00aec5, background color: #ffffff, font size: 13.5pt (18px), font weight: bold). Expected contrast ratio of 4.5:1

## 7. Elements must meet minimum color contrast ratio thresholds

- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** div:nth-child(3) > .short-description > .readmore
- **HTML:**
...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** div:nth-child(4) > .short-description > .readmore
- **HTML:**
...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** div:nth-child(5) > .short-description > .readmore
- **HTML:**
...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** div:nth-child(6) > .short-description > .readmore
- **HTML:**
...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** div:nth-child(7) > .short-description > .readmore
- **HTML:**
...
## 51. Elements must meet minimum color contrast ratio thresholds
...
## 52. Elements must meet minimum color contrast ratio thresholds
...
## 53. Elements must meet minimum color contrast ratio thresholds
...
## 54. Frames must have an accessible name

- **Description:** Ensure <iframe> and <frame> elements have an accessible name
- **Selector:** iframe[width="172"]
- **HTML:**
...
## 55. Images must have alternative text
...
## 56. Images must have alternative text

- **Description:** Ensure <img> elements have alternative text or a role of none or presentation
- **Selector:** .featured-img
- **HTML:**
...
## 57. Images must have alternative text
...
## 58. Document should have one main landmark
...
## 59. Links must be distinguishable without relying on color
...
## 60. Links must have discernible text
...
## 61. Links must have discernible text
...
## 62. Links must have discernible text
...
## 63. Links must have discernible text

- **Description:** Ensure links have discernible text
- **Selector:** .fa-stack.fa-7x[href$="login.html"]
- **HTML:**

```
<a class="fa-stack fa-7x cta-btn" rel="noopener" href="/login.html"> <em class="fa fa-circle fa-stack-2x"></em> <em class="fal fa-id-card fa-stack-1x fa-inverse"></em> </a>
```
...
## 64. Links must have discernible text

- **Description:** Ensure links have discernible text
- **Selector:** .col-md-3[align="center"]:nth-child(2) > .fa-stack.fa-7x.cta-btn
- **HTML:**

```
<a class="fa-stack fa-7x cta-btn" rel="noopener" href="/site/educ/becomeanRT?nav=sidebar"> <em class="fa fa-circle fa-stack-2x"></em> <em class="fal fa-user-md fa-stack-1x fa-inverse"></em> </a>
```
...
## 65. Links must have discernible text

- **Description:** Ensure links have discernible text
- **Selector:** .col-md-3[align="center"]:nth-child(3) > .fa-stack.fa-7x.cta-btn
- **HTML:**

```
<a class="fa-stack fa-7x cta-btn" rel="noopener" href="/site/public/complaints?nav=sidebar"> <em class="fa fa-circle fa-stack-2x"></em> <em class="fal fa-users fa-stack-1x fa-inverse"></em> </a>
```
...
## 66. Links must have discernible text

- **Description:** Ensure links have discernible text
- **Selector:** .col-md-3[align="center"]:nth-child(4) > .fa-stack.fa-7x.cta-btn
- **HTML:**

```
<a class="fa-stack fa-7x cta-btn" rel="noopener" href="/client/roster/clientRosterView.html?clientRosterId=138"> <em class="fa fa-circle fa-stack-2x"></em> <em class="fal fa-address-book fa-stack-1x fa-inverse"></em> </a>
```
...
## 67. Links must have discernible text

- **Description:** Ensure links have discernible text
- **Selector:** .featured-img-bg > a
- **HTML:**

```
<a href="https://marrt.org/company/roster/companyRosterDetails.html?companyId=61054&amp;companyRosterId=156"> <img src="/uploaded/inst/5704858/587864/Capture.JPG" class="featured-img img-fluid"> </a>
```
...
## 68. Page should contain a level-one heading
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** .col-xl-12.col-sm-12[data-roster-column=""] > .heading-right
- **HTML:**

```
<div class="heading-right">Featured Content</div>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** .col-md-4 > .heading-right
- **HTML:**

```
<div class="heading-right">TWITTER</div>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** a[href$="MARRT1981"]
- **HTML:**

```
<a class="twitter-timeline" href="https://twitter.com/MARRT1981" data-tweet-limit="2" data-aria-polite="assertive" data-width="350" data-twitter-extracted-i1746460213372449195="true"> Tweets by MARRT </a>
```
