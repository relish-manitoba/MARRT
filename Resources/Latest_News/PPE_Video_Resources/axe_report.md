...
## 44. Headings should not be empty

- **Description:** Ensure headings have discernible text
- **Selector:** h4:nth-child(7)
- **HTML:**
...
## 49. Document should have one main landmark
...
- **Selector:** h4:nth-child(12) > .Normal12pt > a[target="_self"]
- **HTML:**

```
<a target="_self" href="https://www.gov.mb.ca/health/coronavirus/index.html">Link Here</a>
```

- **Failure Summary:** Fix any of the following:
  The link has insufficient color contrast of 1.21:1 with the surrounding text. (Minimum contrast is 3:1, link text: #547699, surrounding text: #666666)
