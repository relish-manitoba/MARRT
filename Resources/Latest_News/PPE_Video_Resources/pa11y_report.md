...
## 8. Heading tag found with no content. Text that is not intended as a heading should not be marked up with heading tags.

- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H42.2
- **Selector:** #centerInfo > h4:nth-child(7)
- **Type:** error
- **Type Code:** 1
- **Context:**
