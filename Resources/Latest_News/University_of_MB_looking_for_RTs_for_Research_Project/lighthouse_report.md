...
## 13. `<frame>` or `<iframe>` elements do not have a title
...
## 14. Image elements do not have `[alt]` attributes
...
```
<img src="https://marrt.olasoft.com/uploaded/web/Terminal%20Extubation%20Recruitment…" alt="" width="488" height="491" style="display: block; margin-left: auto; margin-right: auto;">
```
