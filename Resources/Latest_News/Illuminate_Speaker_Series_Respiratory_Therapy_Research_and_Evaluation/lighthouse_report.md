...
- **Selector:** div#companyRosterDetails > div > div > img
- **Snippet:**

```
<img src="https://marrt.org/uploaded/web/Capture.JPG" alt="image">
```

## 3. Serves images with low resolution
...
## 17. `<frame>` or `<iframe>` elements do not have a title
