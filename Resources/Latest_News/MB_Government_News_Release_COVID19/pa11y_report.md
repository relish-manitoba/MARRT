...
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > blockquote > div > div
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<div align="center"> <table> <tbody> <tr> <td> <div...</div>
```

## 9. Align attributes .

- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > blockquote > div > div > table:nth-child(1) > tbody > tr > td > div
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<div align="center"><img alt="Manitoba News Release...</div>
```

## 10. Align attributes .

- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > blockquote > div > div > table:nth-child(2) > tbody > tr > td > table > tbody > tr > td > table > tbody > tr > td > p:nth-child(1)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<p align="right">March 10, 2020</p>
```

## 11. Align attributes .

- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > blockquote > div > div > table:nth-child(2) > tbody > tr > td > table > tbody > tr > td > table > tbody > tr > td > p:nth-child(2)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<p align="center">PROVINCE WORKING WITH OTHER JUR...</p>
```

## 12. Align attributes .

- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > blockquote > div > div > table:nth-child(2) > tbody > tr > td > table > tbody > tr > td > table > tbody > tr > td > p:nth-child(3)
- **Type:** error
- **Type Code:** 1
- **Context:**
...
- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > blockquote > div > div > table:nth-child(2) > tbody > tr > td > table > tbody > tr > td > table > tbody > tr > td > p:nth-child(4)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<p align="center">Equipment Will Ensure Patients ...</p>
```

## 14. Align attributes .

- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > blockquote > div > div > table:nth-child(2) > tbody > tr > td > table > tbody > tr > td > table > tbody > tr > td > p:nth-child(5)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<p align="justify">The Manitoba government is work...</p>
```

## 15. Align attributes .

- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > blockquote > div > div > table:nth-child(2) > tbody > tr > td > table > tbody > tr > td > table > tbody > tr > td > p:nth-child(11)
- **Type:** error
- **Type Code:** 1
- **Context:**
...
- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > blockquote > div > div > table:nth-child(2) > tbody > tr > td > table > tbody > tr > td > table > tbody > tr > td > ul > li:nth-child(1)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<li align="justify">Public information, contact Man...</li>
```

## 17. Align attributes .

- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > blockquote > div > div > table:nth-child(2) > tbody > tr > td > table > tbody > tr > td > table > tbody > tr > td > ul > li:nth-child(2)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<li align="justify">Media requests for general info...</li>
```

## 18. Align attributes .

- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > blockquote > div > div > table:nth-child(2) > tbody > tr > td > table > tbody > tr > td > table > tbody > tr > td > ul > li:nth-child(3)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<li align="justify">Media requests for ministerial ...</li>
```
