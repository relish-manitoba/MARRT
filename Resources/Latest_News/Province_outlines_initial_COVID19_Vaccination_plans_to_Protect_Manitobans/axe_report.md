...
- **Selector:** p:nth-child(20) > span > a[target="_blank"][rel="noopener"]
- **HTML:**

```
<a href="http://www.manitoba.ca/covid19/vaccine/jobs.html" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://www.manitoba.ca/covid19/vaccine/jobs.html&amp;source=gmail&amp;ust=1607634094209000&amp;usg=AFQjCNEmJ8s5T7FSKcYpymgo3lWBdUUg6w" style="color: #1155cc;" rel="noopener">
```

- **Failure Summary:** Fix any of the following:
  The link has insufficient color contrast of 2.42:1 with the surrounding text. (Minimum contrast is 3:1, link text: #1155cc, surrounding text: #222222)
  The link has no styling (such as underline) to distinguish it from the surrounding text

## 50. Links must be distinguishable without relying on color

- **Description:** Ensure links are distinguished from surrounding text in a way that does not rely on color
- **Selector:** a[href$="COVID19"]
- **HTML:**

```
<a href="http://www.manitoba.ca/COVID19" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://www.manitoba.ca/COVID19&amp;source=gmail&amp;ust=1607634094209000&amp;usg=AFQjCNGJHBKRDtDA9CscYF2G6kJPs97HsQ" style="color: #1155cc;" rel="noopener">www.manitoba.ca/COVID19</a>
```
...
## 55. Page should contain a level-one heading
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** #companyRoster-159-link-back
- **HTML:**

```
<a class="btn btn-light" href="javascript:goBack();" id="companyRoster-159-link-back"><span class="fal fa-arrow-circle-left" aria-hidden="true"></span> Back</a>
```
...
```
<a class="btn btn-light" href="javascript:" id="printResults"><span class="fal fa-print" aria-hidden="true"></span> Print</a>
```
