...
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > p:nth-child(1)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<p align="center" style="color: #222222; font-family: Arial, Helvetica, sans-serif; font-size: small; background-color: #ffffff; margin-top: 0in; text-align: center;"><b><span style="font-family: Ar...</p>
```

## 9. Align attributes .

- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > p:nth-child(2)
- **Type:** error
- **Type Code:** 1
- **Context:**
...
- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > p:nth-child(3)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<p align="center" style="color: #222222; font-family: Arial, Helvetica, sans-serif; font-size: small; background-color: #ffffff; margin-right: 0in; margin-bottom: 18.75pt; margin-left: 0in; text-align: center;"><b><span style="font-family: Ar...</p>
```

## 11. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.
...
## 16. Iframe element requires a non-empty title attribute that identifies the frame.
...
## 17. This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 4.5:1, but text in this element has a contrast ratio of 2.43:1. Recommendation:  change background to #feffff.
...
## 24. This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 4.5:1, but text in this element has a contrast ratio of 2.43:1. Recommendation:  change background to #feffff.
...
## 54. This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 4.5:1, but text in this element has a contrast ratio of 2.43:1. Recommendation:  change background to #feffff.
