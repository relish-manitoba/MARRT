...
- **Selector:** #companyRosterDetails > div:nth-child(3) > div:nth-child(4) > table:nth-child(3) > tbody > tr > td > table
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnBoxedTextContentContainer" style="text-size-adjust: 100%; min-width: 100%;"> <tbody> <tr> <td style="text-s...</table>
```
