...
## 7. Duplicate id attribute value "2032" found on the web page.
...
```
<a class="nav-link" id="2032" href="/client/career/careers.html" target="true">
                            
 ...</a>
```

## 8. This button element does not have a name available to an accessibility API. Valid names are: title undefined, element content, aria-label undefined, aria-labelledby undefined.
...
## 9. Anchor element found with a valid href attribute, but no link content has been supplied.
...
## 10. Anchor element found with a valid href attribute, but no link content has been supplied.
...
## 13. Anchor element found with a valid href attribute, but no link content has been supplied.
...
- **Code:** WCAG2AA.Principle4.Guideline4_1.4_1_2.H91.A.NoContent
- **Selector:** #content > p:nth-child(4) > a:nth-child(17)
- **Type:** error
- **Type Code:** 1
- **Context:**
...
- **Code:** WCAG2AA.Principle4.Guideline4_1.4_1_2.H91.A.NoContent
- **Selector:** #content > p:nth-child(4) > a:nth-child(19)
- **Type:** error
- **Type Code:** 1
- **Context:**
...
- **Code:** WCAG2AA.Principle4.Guideline4_1.4_1_2.H91.A.NoContent
- **Selector:** #content > p:nth-child(7) > a:nth-child(1)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<a href="https://www.thoracic.org/" target="_blank" rel="noopener"> <em class="fa fa-arrow-up-righ...</a>
```

## 20. Anchor element found with a valid href attribute, but no link content has been supplied.

- **Code:** WCAG2AA.Principle4.Guideline4_1.4_1_2.H91.A.NoContent
- **Selector:** #content > p:nth-child(7) > a:nth-child(3)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<a href="http://www.spph.ubc.ca/continuing-education/outdoor-air-quality/" target="_blank" rel="noopener"> <em class="fa fa-arrow-up-righ...</a>
```

## 21. Anchor element found with a valid href attribute, but no link content has been supplied.

- **Code:** WCAG2AA.Principle4.Guideline4_1.4_1_2.H91.A.NoContent
- **Selector:** #content > p:nth-child(7) > a:nth-child(5)
- **Type:** error
- **Type Code:** 1
- **Context:**
...
- **Code:** WCAG2AA.Principle4.Guideline4_1.4_1_2.H91.A.NoContent
- **Selector:** #content > p:nth-child(7) > a:nth-child(7)
- **Type:** error
- **Type Code:** 1
- **Context:**
...
- **Code:** WCAG2AA.Principle4.Guideline4_1.4_1_2.H91.A.NoContent
- **Selector:** #content > p:nth-child(7) > a:nth-child(9)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<a href="#" target="_blank" rel="noopener"> <em class="fa fa-arrow-up-righ...</a>
```

## 24. Anchor element found with a valid href attribute, but no link content has been supplied.

- **Code:** WCAG2AA.Principle4.Guideline4_1.4_1_2.H91.A.NoContent
- **Selector:** #content > p:nth-child(7) > a:nth-child(11)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<a href="https://www.healthelearning.ca/lms/my/catalogue/index.php?id=27&amp;subid=75&amp;productid=396&amp;producttype=training&amp;action=view&amp;utm_source=MARRT&amp;utm_medium=linkonly&amp;utm_campaign=CRE%20Program" target="_blank" rel="noopene...
```

## 25. Anchor element found with a valid href attribute, but no link content has been supplied.

- **Code:** WCAG2AA.Principle4.Guideline4_1.4_1_2.H91.A.NoContent
- **Selector:** #content > p:nth-child(7) > a:nth-child(13)
- **Type:** error
- **Type Code:** 1
- **Context:**
...
- **Code:** WCAG2AA.Principle4.Guideline4_1.4_1_2.H91.A.NoContent
- **Selector:** #content > p:nth-child(7) > a:nth-child(15)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<a href="http://www.patientsafetyinstitute.ca/en/toolsResources/safetyCompetencies/Pages/default.aspx" target="_blank" rel="noopener"> <em class="fa fa-arrow-up-righ...</a>
```
...
## 32. Iframe element requires a non-empty title attribute that identifies the frame.
...
## 33. This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 4.5:1, but text in this element has a contrast ratio of 2.43:1. Recommendation:  change background to #feffff.
...
## 63. This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 4.5:1, but text in this element has a contrast ratio of 2.43:1. Recommendation:  change background to #feffff.
