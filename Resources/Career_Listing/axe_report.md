...
## 47. Form elements must have labels
...
## 48. Form elements must have labels
...
## 49. Form elements must have labels
...
## 52. Form elements must have labels
...
## 53. Document should have one main landmark
...
- **Description:** Ensure links have discernible text
- **Selector:** a[href$="careers.rss"]
- **HTML:**

```
<a href="/client/career/careers.rss">
                            <i class="fal fa-rss-square" aria-hidden="true"></i>
                        </a>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** .card.mb-2 > .card-header.initialism
- **HTML:**

```
<div class="card-header initialism">
                        Search careers
                    </div>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** div[data-struct="i_careerFilter.title"]
- **HTML:**

```
<div data-struct="i_careerFilter.title" class="row mb-2">
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** div[data-struct="i_careerFilter.postDate"]
- **HTML:**

```
<div data-struct="i_careerFilter.postDate" class="row mb-2">
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** div[data-struct="i_careerFilter.endDate"]
- **HTML:**

```
<div data-struct="i_careerFilter.endDate" class="row mb-2">
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** div[data-struct="i_careerFilter.description"]
- **HTML:**

```
<div data-struct="i_careerFilter.description" class="row mb-2">
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** div[data-struct="i_careerFilter.type"]
- **HTML:**

```
<div data-struct="i_careerFilter.type" class="row mb-2">
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** div[data-struct="i_careerFilter.status"]
- **HTML:**

```
<div data-struct="i_careerFilter.status" class="row mb-2">
```
...
```
<input id="expired" name="expired" class="form-check-input" type="checkbox" value="true">
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** label[for="expired"]
- **HTML:**

```
<label for="expired" title="Show expired posts">Show expired posts</label>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** .my-4 > .card-header.initialism
- **HTML:**
...
```
<span class="pagebanner">1 Career found.</span>
```
...
## 80. Select element must have an accessible name
