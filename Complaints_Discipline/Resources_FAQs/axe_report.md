...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** .d-sm-none > .side-nav > .side-navbg > .menu-1997 > .currentMenuItem > .nav-link[aria-current="page"][href="/site/public/faq?nav=sidebar"] > .nav-label
- **HTML:**

```
<span class="nav-label">Frequently Asked Questions </span>
```
...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** .footerlink > a[href="/site/public/faq?nav=sidebar"]
- **HTML:**
...
## 46. Images must have alternative text
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** .d-sm-none > .side-nav > .side-navbg > .menu-1997
- **HTML:**

```
<ul class=" navigation menu-1997">
```
...
## 56. All page content should be contained by landmarks
...
```
<p class="card-question"><a data-bs-toggle="collapse" href="#1"> <strong>How are Colleges of Respiratory Therapy across Canada able to operate with lower license fees? <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
```
<p class="card-question"><a data-bs-toggle="collapse" href="#2"> <strong>If we already are self-regulated, then what is changing? <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
```
<p class="card-question"><a data-bs-toggle="collapse" href="#3"> <strong>How do other provinces pay for it? <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
```
<p class="card-question"><a data-bs-toggle="collapse" href="#4"> <strong>What will the new composition of the College look like? <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
```
<p class="card-question"><a data-bs-toggle="collapse" href="#5"> <strong>Council to manage affairs <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** p:nth-child(18)
- **HTML:**

```
<p class="card-question"><a data-bs-toggle="collapse" href="#6"> <strong>Composition of council <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
```
<p class="card-question"><a data-bs-toggle="collapse" href="#7"> <strong>Public representatives appointed by minister <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
```
<p class="card-question"><a data-bs-toggle="collapse" href="#8"> <strong>Additional council members <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** p:nth-child(27)
- **HTML:**

```
<p class="card-question"><a data-bs-toggle="collapse" href="#9"> <strong>Public representatives <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
```
<p class="card-question"><a data-bs-toggle="collapse" href="#a"> <strong>Committees <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
```
<p class="card-question"><a data-bs-toggle="collapse" href="#b"> <strong>Appointments committee re public representatives <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
```
<p class="card-question"><a data-bs-toggle="collapse" href="#c"> <strong>Additional committees <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
```
<p class="card-question"><a data-bs-toggle="collapse" href="#d"> <strong>The College will hire a Registrar and staff <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
```
<p class="card-question"><a data-bs-toggle="collapse" href="#e"> <strong>What will the new college do? <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** p:nth-child(45)
- **HTML:**

```
<p class="card-question"><a data-bs-toggle="collapse" href="#f"> <strong>What will it cost? <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** p:nth-child(48)
- **HTML:**

```
<p class="card-question"><a data-bs-toggle="collapse" href="#g"> <strong>Will we consider reducing fees after we are done with the self-regulating process? <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** p:nth-child(51)
- **HTML:**

```
<p class="card-question"><a data-bs-toggle="collapse" href="#h"> <strong>Will there be optional monthly payment plans available? <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** p:nth-child(54)
- **HTML:**

```
<p class="card-question"><a data-bs-toggle="collapse" href="#i"> <strong>Is this a tax deductible cost? <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** p:nth-child(57)
- **HTML:**

```
<p class="card-question"><a data-bs-toggle="collapse" href="#j"> <strong>Who did MARRT consult? <em class="fa fa-angles-down"></em></strong> </a></p>
```
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** p:nth-child(60)
- **HTML:**

```
<p class="card-question"><a data-bs-toggle="collapse" href="#k"> <strong>Will transitioning to operating as a college under RHPA will directly affect my rate of pay? <em class="fa fa-angles-down"></em></strong> </a></p>
```
