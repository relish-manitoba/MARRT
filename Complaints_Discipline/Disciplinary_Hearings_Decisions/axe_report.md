...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** .d-sm-none > .side-nav > .side-navbg > .menu-1997.navigation > .currentMenuItem.nav-item > .nav-link[aria-current="page"][target="_self"] > .nav-label
- **HTML:**
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** .d-sm-none > .side-nav > .side-navbg > .menu-1997.navigation
- **HTML:**
