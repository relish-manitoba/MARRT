...
- **Selector:** div.col-md-6 > div.row > div.col-md-8 > input#name
- **Snippet:**
...
- **Description:** Labels ensure that form controls are announced properly by assistive technologies, like screen readers. [Learn more about form element labels](https://dequeuniversity.com/rules/axe/4.10/label).
- **Selector:** div.row > div.col-md-8 > div.input-group > input.date
- **Snippet:**

```
<input class="date form-control flatpickr-input flatpickr-mobile" tabindex="1" type="date" placeholder="">
```

## 21. Form elements do not have associated labels

- **Description:** Labels ensure that form controls are announced properly by assistive technologies, like screen readers. [Learn more about form element labels](https://dequeuniversity.com/rules/axe/4.10/label).
- **Selector:** div.col-md-6 > div.row > div.col-md-8 > input#description
- **Snippet:**
...
- **Description:** Link text (and alternate text for images, when used as links) that is discernible, unique, and focusable improves the navigation experience for screen reader users. [Learn how to make links accessible](https://dequeuniversity.com/rules/axe/4.10/link-name).
- **Selector:** div.card-body > div.row > div.col-md-12 > a
- **Snippet:**
...
## 25. Links rely on color to be distinguishable.
...
## 26. Select elements do not have associated label elements.
...
- **Selector:** div.col-md-6 > div.row > div.col-md-8 > select#type
- **Snippet:**
...
## 27. Select elements do not have associated label elements.

- **Description:** Form elements without effective labels can create frustrating experiences for screen reader users. [Learn more about the `select` element](https://dequeuniversity.com/rules/axe/4.10/select-name).
- **Selector:** div.col-md-6 > div.row > div.col-md-8 > select#active
- **Snippet:**
...
## 28. Some elements have a `[tabindex]` value greater than 0
...
- **Selector:** div.table-responsive > ul.pagination > li.disabled > a.page-link
- **Snippet:**
...
## 30. Touch targets do not have sufficient size or spacing.
...
## 31. Serve static assets with an efficient cache policy
...
## 32. Avoid enormous network payloads
...
## 37. Serve images in next-gen formats
...
## 42. Avoid serving legacy JavaScript to modern browsers
...
## 45. Page prevented back/forward cache restoration
...
## 49. Use efficient cache lifetimes
