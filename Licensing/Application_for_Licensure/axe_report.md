...
```
<span class="nav-label">Application for Licensure</span>
```
...
```
<a href="https://marrt.org/client/roster/clientRosterView.html?clientRosterId=105">click here</a>
```
...
- **Description:** Ensure links are distinguished from surrounding text in a way that does not rely on color
- **Selector:** p:nth-child(10) > a:nth-child(1)
- **HTML:**

```
<a href="https://marrt.org/client/roster/clientRosterView.html?clientRosterId=138">Registered Respiratory Therapists</a>
```
...
```
<a href="https://marrt.org/uploaded/web/MARRT%2520New%2520Member%2520Information%2520Guide%25202024.pdf" target="_blank" rel="noopener">please click here.</a>
```
