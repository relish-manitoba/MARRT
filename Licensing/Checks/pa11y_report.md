...
```
<a class="nav-link" id="3480" aria-current="page" href="/site/licensing/checks?nav=sidebar" target="_self">
...
- **Selector:** #content > table:nth-child(1) > tbody > tr > td > table
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<table align="left" cellpadding="0" cellspacing="0" border="0" style="width: 100.0%;">
<tbody>
<tr>
<td valign="top">...</table>
```
...
- **Code:** WCAG2AA.Principle1.Guideline1_3.1_3_1.H49.AlignAttr
- **Selector:** #content > table:nth-child(3) > tbody > tr > td > table
- **Type:** error
- **Type Code:** 1
- **Context:**
