...
- **Description:** Low-contrast text is difficult or impossible for many users to read. [Learn how to provide sufficient color contrast](https://dequeuniversity.com/rules/axe/4.10/color-contrast).
- **Selector:** ul.navigation > li.nav-item > a#2026 > span.nav-label
- **Snippet:**
...
```
<a href="https://marrt.org/uploaded/web/Other%20Provincial%20College%20Annual%20Due…">
```
...
## 23. `<td>` elements in a large `<table>` do not have table headers.
...
- **Selector:** div.col-md-8 > div.content > div#content > table
- **Snippet:**

```
<table border="2" style="border-collapse: collapse; width: 100%; height: 419px;">
```
...
## 38. Links do not have descriptive text
