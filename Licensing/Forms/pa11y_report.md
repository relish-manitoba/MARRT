...
```
<a class="nav-link" id="2027" href="/site/licensing/renewal?nav=sidebar" target="_self">
                            
 ...</a>
```

## 10. Duplicate id attribute value "3319" found on the web page.
...
## 11. Duplicate id attribute value "3480" found on the web page.
...
## 12. Duplicate id attribute value "2026" found on the web page.
...
## 13. Duplicate id attribute value "2771" found on the web page.
...
## 14. Duplicate id attribute value "3483" found on the web page.
...
## 15. Duplicate id attribute value "2321" found on the web page.
...
## 16. Duplicate id attribute value "3479" found on the web page.
...
```
<a class="nav-link" id="3479" aria-current="page" href="/site/licensing/forms?nav=sidebar" target="_self">
                            
 ...</a>
```

## 17. This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 4.5:1, but text in this element has a contrast ratio of 4.28:1. Recommendation:  change background to #f9f9fa.
