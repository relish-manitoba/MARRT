...
```
<span class="nav-label">Professional Liability Insurance</span>
```
...
- **Selector:** p:nth-child(3) > a
- **HTML:**

```
<a href="https://marrt.org/uploaded/web/Policies/L-06%20Professional%20Liability%20Insurance%20Policy%20(2).pdf">L-06 Professional Liability Insurance Policy</a>
```
...
```
<a rel="noopener" target="_blank" href="mailto:knollet@csrt.com">Katherine Nollet</a>
```
