...
```
<a class="nav-link" id="2028" aria-current="page" href="/site/licensing/types?nav=sidebar" target="_self">
...
```
<span class="nav-label">Types of Membership</span>
```

## 9. Duplicate id attribute value "2025" found on the web page.
...
## 10. Duplicate id attribute value "2027" found on the web page.
