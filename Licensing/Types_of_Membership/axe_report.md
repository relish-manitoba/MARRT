...
- **Selector:** p:nth-child(6) > a[target="_blank"][rel="noopener"]
- **HTML:**

```
<a href="/client/roster/clientRosterView.html?clientRosterId=105" target="_blank" rel="noopener">Registration with MARRT</a>
```
