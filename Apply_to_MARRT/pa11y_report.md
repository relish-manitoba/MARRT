...
- **Code:** WCAG2AA.Principle4.Guideline4_1.4_1_2.H91.A.NoContent
- **Selector:** html > body > div:nth-child(1) > div:nth-child(4) > div > div > div > div > div > blockquote > a:nth-child(11)
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<a href="mailto:admin@marrt.org"></a>
```

## 8. This textinput element does not have a name available to an accessibility API. Valid names are: label element, title undefined, aria-label undefined, aria-labelledby undefined.
...
## 10. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.
...
## 15. Iframe element requires a non-empty title attribute that identifies the frame.
...
## 16. This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 4.5:1, but text in this element has a contrast ratio of 2.43:1. Recommendation:  change background to #feffff.
