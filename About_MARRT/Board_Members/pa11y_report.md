...
```
<a class="nav-link" id="2001" aria-current="page" href="/site/about/boardmembers?nav=sidebar" target="_self">
                            
 ...</a>
```

## 11. This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 4.5:1, but text in this element has a contrast ratio of 4.28:1. Recommendation:  change background to #f9f9fa.
...
```
<span class="nav-label">Board Members</span>
```
...
- **Selector:** #content > div:nth-child(3) > img
- **Type:** error
- **Type Code:** 1
- **Context:**
...
- **Code:** WCAG2AA.Principle1.Guideline1_1.1_1_1.H37
- **Selector:** #content > div:nth-child(7) > div:nth-child(1) > div > img
- **Type:** error
- **Type Code:** 1
- **Context:**
...
## 18. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.

- **Code:** WCAG2AA.Principle1.Guideline1_1.1_1_1.H37
- **Selector:** #content > div:nth-child(7) > div:nth-child(2) > div > img
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<img src="/uploaded/web/Board/ftolaj.jpg" class="img-fluid">
```

## 19. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.

- **Code:** WCAG2AA.Principle1.Guideline1_1.1_1_1.H37
- **Selector:** #content > div:nth-child(7) > div:nth-child(3) > div > img
- **Type:** error
- **Type Code:** 1
- **Context:**
...
## 20. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.

- **Code:** WCAG2AA.Principle1.Guideline1_1.1_1_1.H37
- **Selector:** #content > div:nth-child(9) > div:nth-child(1) > div > img
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<img src="/uploaded/web/Board/ihay.jpg" class="img-fluid">
```

## 21. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.

- **Code:** WCAG2AA.Principle1.Guideline1_1.1_1_1.H37
- **Selector:** #content > div:nth-child(9) > div:nth-child(2) > div > img
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<img src="/uploaded/web/Board/jsambrook.jpg" class="img-fluid">
```

## 22. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.

- **Code:** WCAG2AA.Principle1.Guideline1_1.1_1_1.H37
- **Selector:** #content > div:nth-child(9) > div:nth-child(3) > div > img
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<img src="/uploaded/web/Board/rmistry.jpg" class="img-fluid">
```

## 23. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.

- **Code:** WCAG2AA.Principle1.Guideline1_1.1_1_1.H37
- **Selector:** #content > div:nth-child(11) > div:nth-child(1) > div > img
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<img src="/uploaded/web/Board/ccampbell.jpg" class="img-fluid">
```

## 24. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.

- **Code:** WCAG2AA.Principle1.Guideline1_1.1_1_1.H37
- **Selector:** #content > div:nth-child(11) > div:nth-child(2) > div > img
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<img src="/uploaded/web/Board/default-user.jpg" class="img-fluid">
```

## 25. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.

- **Code:** WCAG2AA.Principle1.Guideline1_1.1_1_1.H37
- **Selector:** #content > div:nth-child(11) > div:nth-child(3) > div > img
- **Type:** error
- **Type Code:** 1
- **Context:**
...
## 26. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.

- **Code:** WCAG2AA.Principle1.Guideline1_1.1_1_1.H37
- **Selector:** #content > div:nth-child(13) > div:nth-child(1) > div > img
- **Type:** error
- **Type Code:** 1
- **Context:**
...
## 27. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.

- **Code:** WCAG2AA.Principle1.Guideline1_1.1_1_1.H37
- **Selector:** #content > div:nth-child(13) > div:nth-child(2) > div > img
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<img src="/uploaded/web/Board/kfoster.jpg" class="img-fluid">
```

## 28. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.

- **Code:** WCAG2AA.Principle1.Guideline1_1.1_1_1.H37
- **Selector:** #content > div:nth-child(13) > div:nth-child(3) > div > img
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<img src="/uploaded/web/Board/lhurton.jpg" class="img-fluid">
```

## 29. Img element missing an alt attribute. Use the alt attribute to specify a short text alternative.
...
## 34. Iframe element requires a non-empty title attribute that identifies the frame.
...
## 72. This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 4.5:1, but text in this element has a contrast ratio of 2.43:1. Recommendation:  change background to #feffff.
...
## 79. This element's role is "presentation" but contains child elements with semantic meaning.
