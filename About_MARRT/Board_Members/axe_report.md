...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** .d-sm-none > .side-nav > .side-navbg > .menu-1993 > .currentMenuItem > .nav-link[aria-current="page"][target="_self"] > .nav-label
- **HTML:**
...
## 46. Heading levels should only increase by one

- **Description:** Ensure the order of headings is semantically correct
- **Selector:** .row:nth-child(7) > .col-md-4:nth-child(1) > .card > .card-body > h5
- **HTML:**

```
<h5 class="card-title">Nora Staunton</h5>
```

- **Failure Summary:** Fix any of the following:
  Heading order invalid

## 47. Heading levels should only increase by one

- **Description:** Ensure the order of headings is semantically correct
- **Selector:** .row:nth-child(13) > .col-md-4:nth-child(1) > .card > .card-body > h5
- **HTML:**

```
<h5 class="card-title">Deborah Handziuk</h5>
```
...
## 49. Images must have alternative text
...
## 50. Images must have alternative text

- **Description:** Ensure <img> elements have alternative text or a role of none or presentation
- **Selector:** .row:nth-child(7) > .col-md-4:nth-child(1) > .card > img
- **HTML:**
...
## 51. Images must have alternative text

- **Description:** Ensure <img> elements have alternative text or a role of none or presentation
- **Selector:** img[src$="ftolaj.jpg"]
- **HTML:**
...
- **Description:** Ensure <img> elements have alternative text or a role of none or presentation
- **Selector:** .row:nth-child(7) > .col-md-4:nth-child(3) > .card > img
- **HTML:**
...
## 54. Images must have alternative text

- **Description:** Ensure <img> elements have alternative text or a role of none or presentation
- **Selector:** .row:nth-child(9) > .col-md-4:nth-child(2) > .card > img
- **HTML:**
...
- **Description:** Ensure <img> elements have alternative text or a role of none or presentation
- **Selector:** .row:nth-child(9) > .col-md-4:nth-child(3) > .card > img
- **HTML:**
...
- **Description:** Ensure <img> elements have alternative text or a role of none or presentation
- **Selector:** .row:nth-child(11) > .col-md-4:nth-child(1) > .card > img
- **HTML:**
...
- **Description:** Ensure <img> elements have alternative text or a role of none or presentation
- **Selector:** .row:nth-child(11) > .col-md-4:nth-child(2) > .card > img
- **HTML:**
...
## 58. Images must have alternative text

- **Description:** Ensure <img> elements have alternative text or a role of none or presentation
- **Selector:** .row:nth-child(11) > .col-md-4:nth-child(3) > .card > img
- **HTML:**
...
## 59. Images must have alternative text

- **Description:** Ensure <img> elements have alternative text or a role of none or presentation
- **Selector:** .row:nth-child(13) > .col-md-4:nth-child(1) > .card > img
- **HTML:**
...
## 60. Images must have alternative text

- **Description:** Ensure <img> elements have alternative text or a role of none or presentation
- **Selector:** .row:nth-child(13) > .col-md-4:nth-child(2) > .card > img
- **HTML:**
...
## 61. Images must have alternative text

- **Description:** Ensure <img> elements have alternative text or a role of none or presentation
- **Selector:** .row:nth-child(13) > .col-md-4:nth-child(3) > .card > img
- **HTML:**
...
## 62. Images must have alternative text
...
## 63. Document should have one main landmark
...
## 64. Links must be distinguishable without relying on color
...
- **Description:** Ensure all page content is contained by landmarks
- **Selector:** .d-sm-none > .side-nav > .side-navbg > .menu-1993
- **HTML:**
