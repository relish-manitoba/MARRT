...
```
<a class="nav-link" id="2012" aria-current="page" href="/site/profession/bylaws?nav=sidebar" target="_self">
...
```
<span class="nav-label">MARRT By-laws</span>
```
...
- **Code:** WCAG2AA.Principle4.Guideline4_1.4_1_2.H91.A.NoContent
- **Selector:** #content > p:nth-child(8) > a
- **Type:** error
- **Type Code:** 1
- **Context:**

```
<a href="https://marrt.olasoft.com/uploaded/web/website/MARRT%20ByLaws%20-%202019%20CURRENT.pdf" target="_blank" rel="noopener">&nbsp;</a>
```
