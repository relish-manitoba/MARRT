...
```
<span class="nav-label">RHPA</span>
```
...
- **Description:** Ensure the contrast between foreground and background colors meets WCAG 2 AA minimum contrast ratio thresholds
- **Selector:** .footerlink > a:nth-child(4)
- **HTML:**
...
- **Selector:** a[target="_blank"][rel="noopener"]:nth-child(1)
- **HTML:**

```
<a href="https://www.youtube.com/watch?v=z4ZxNDkoo3o" target="_blank" rel="noopener">Click here</a>
```
...
- **Description:** Ensure links are distinguished from surrounding text in a way that does not rely on color
- **Selector:** a[target="_blank"][rel="noopener"]:nth-child(4)
- **HTML:**

```
<a href="http://marrt.olasoft.com/uploaded/web/website/What%20It%20Costs%20to%20Run%20a%20Health%20Regulatory%20College_June%202016_CRTO%20(1).pdf" target="_blank" rel="noopener">Click here</a>
```
...
- **Description:** Ensure links are distinguished from surrounding text in a way that does not rely on color
- **Selector:** a[target="_blank"][rel="noopener"]:nth-child(7)
- **HTML:**

```
<a href="https://www.regulatoryguide.ca/learn-about-consumer-protection-regulatory-bodies-and-my-rights/" target="_blank" rel="noopener">Click here</a>
```
